...
const star = document.querySelector(".nonactive");
document.addEventListener("DOMContentLoaded", function (event) {
  for (let superHero of superHeros) {
    ...
    name.classList.add("cardHeader");
    const universe = document.createElement("p");
    cardContainer.appendChild(universe);
    universe.textContent = `Вселенная: ${superHero.universe}`;
    universe.classList.add("cardText");
    const alterego = document.createElement("p");
    cardContainer.appendChild(alterego);
    alterego.textContent = `Альтрэго: ${superHero.alterego}`;
    alterego.classList.add("cardText");
    const occupation = document.createElement("p");
    cardContainer.appendChild(occupation);
    occupation.textContent = `Род деятельности: ${superHero.occupation}`;
    occupation.classList.add("cardText");
    const friends = document.createElement("p");
    cardContainer.appendChild(friends);
    friends.textContent = `Друзья: ${superHero.friends}`;
    friends.classList.add("cardText");
    const superpower = document.createElement("p");
    cardContainer.appendChild(superpower);
    superpower.textContent = `Суперсилы: ${superHero.superpowers}`;
    superpower.classList.add("cardText");
    const image = document.createElement("img");
    cardContainer.appendChild(image);
    image.setAttribute("src", superHero.url);
    image.classList.add("cardImage");
    const rating = document.createElement("div");
    cardContainer.appendChild(rating);
    container.appendChild(cardContainer);
    const checkboxContainer = document.createElement("div");
    rating.appendChild(checkboxContainer);
    checkboxContainer.classList.add("checkboxContainer");
    const checkFirstContainer = document.createElement("div");
    checkboxContainer.appendChild(checkFirstContainer);

    const inputFirst = document.createElement("input");
    checkFirstContainer.appendChild(inputFirst);
    inputFirst.setAttribute("type", "radio");
    inputFirst.setAttribute("value", "1");
    inputFirst.setAttribute("name", `${superHero.name}`);
    inputFirst.classList.add("checkbox");
    const starFirst = star.cloneNode(true);
    checkFirstContainer.appendChild(starFirst);
    starFirst.classList.add("star");
    starFirst.classList.remove("nonactive");
    starFirst.setAttribute("id", `1_${superHero.name}`);
    const checkSecondContainer = document.createElement("div");
    checkboxContainer.appendChild(checkSecondContainer);
    const inputSecond = document.createElement("input");
    checkSecondContainer.appendChild(inputSecond);
    inputSecond.setAttribute("type", "radio");
    inputSecond.setAttribute("value", "2");
    inputSecond.classList.add("checkbox");
    inputSecond.setAttribute("name", `${superHero.name}`);
    const starSecond = star.cloneNode(true);
    checkSecondContainer.appendChild(starSecond);
    starSecond.classList.add("star");
    starSecond.classList.remove("nonactive");
    starSecond.setAttribute("id", `2_${superHero.name}`);
    const checkThirdContainer = document.createElement("div");
    checkboxContainer.appendChild(checkThirdContainer);
    const inputThird = document.createElement("input");
    checkThirdContainer.appendChild(inputThird);
    inputThird.setAttribute("type", "radio");
    inputThird.setAttribute("value", "3");
    inputThird.classList.add("checkbox");
    inputThird.setAttribute("name", `${superHero.name}`);
    const starThird = star.cloneNode(true);
    checkThirdContainer.appendChild(starThird);
    starThird.classList.add("star");
    starThird.classList.remove("nonactive");
    starThird.setAttribute("id", `3_${superHero.name}`);
    const checkFouthContainer = document.createElement("div");
    checkboxContainer.appendChild(checkFouthContainer);
    const inputFouth = document.createElement("input");
    checkFouthContainer.appendChild(inputFouth);
    inputFouth.setAttribute("type", "radio");
    inputFouth.setAttribute("value", "4");
    inputFouth.classList.add("checkbox");
    inputFouth.setAttribute("name", `${superHero.name}`);
    const starFouth = star.cloneNode(true);
    checkFouthContainer.appendChild(starFouth);
    starFouth.classList.add("star");
    starFouth.classList.remove("nonactive");
    starFouth.setAttribute("id", `4_${superHero.name}`);
    const checkFifthContainer = document.createElement("div");
    checkboxContainer.appendChild(checkFifthContainer);
    const inputFifth = document.createElement("input");
    checkFifthContainer.appendChild(inputFifth);
    inputFifth.setAttribute("type", "radio");
    inputFifth.setAttribute("value", "5");
    inputFifth.classList.add("checkbox");
    inputFifth.setAttribute("name", `${superHero.name}`);
    const starFifth = star.cloneNode(true);
    checkFifthContainer.appendChild(starFifth);
    starFifth.classList.add("star");
    starFifth.classList.remove("nonactive");
    starFifth.setAttribute("id", `5_${superHero.name}`);
    const stars = [starFirst, starSecond, starThird, starFouth, starFifth];
    const inputs = [
      inputFirst,
      inputSecond,
      inputThird,
    ...
    for (let input of inputs) {
      input.addEventListener("change", () => {
        ...
        for (let i = 0; i < stars.length; i++) {
          if (i < value) {
            stars[i].classList.add("star__yellow");
            stars[i].classList.remove("star");
          } else{
            stars[i].classList.add("star");
            stars[i].classList.remove("star__yellow");
          }
        }
